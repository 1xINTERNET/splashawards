...
/***/ function(module, exports, __webpack_require__) {
	...
	var jQueryOnce = __webpack_require__(3);
	        ...
	        attach: function attach(context, settings) {
	            if (jQuery(context).find('#views-exposed-form-nomination-list-block-2 select').length > 0) {
	                ...
	                jQuery(context).find('.js-nomination-category-menu li').on('click', function (event) {
	                    ...
	                    jQuery(context).find('#views-exposed-form-nomination-list-block-2 select option[value=' + jQuery(event.target).data(dataKey) + ']').selected();
	                    $submitButton.click();
	                });
	            }
	        }
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	(function(e){"use strict";if(true){e(__webpack_require__(1))}else if(typeof define==="function"&&define.amd){define(["jquery"],e)}else{e(jQuery)}})(function(e){"use strict";var n=function(e){e=e||"once";if(typeof e!=="string"){throw new Error("The jQuery Once id parameter must be a string")}return e};e.fn.once=function(t){var r="jquery-once-"+n(t);return this.filter(function(){return e(this).data(r)!==true}).data(r,true)};e.fn.removeOnce=function(e){return this.findOnce(e).removeData("jquery-once-"+n(e))};e.fn.findOnce=function(t){var r="jquery-once-"+n(t);return this.filter(function(){return e(this).data(r)===true})}});
